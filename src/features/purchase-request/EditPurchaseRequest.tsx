// EditRequest.tsx - Optimized with Radix UI
  ...
  if (!purchaseRequest) {
    return (
      <div className="flex justify-center items-center h-64">
        <p className="text-gray-500">No purchase request data available.</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col space-y-3 pb-80">
      <div className="sticky -top-8 z-10 bg-[#F8F8F8] pt-4 md:pt-6 pb-3 space-y-1.5 border-b">
        <div className="flex justify-between items-center">
          <TextHeader>Update Purchase Request</TextHeader>
      ...
      <div className="border w-full rounded-lg">
        <div className="bg-white bg-opacity-90 py-4 md:py-6 lg:py-10 px-2 md:px-6 lg:px-12 w-full rounded-lg">
          <PurchaseRequestForm mode="edit" initialData={purchaseRequest} />
        </div>
      </div>
    </div>
  );
