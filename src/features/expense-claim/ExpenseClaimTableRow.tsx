// ExpenseClaimTableRow.tsx - Refactored to match AdvanceRequestTableRow
import { IExpenseClaim, TableHeaderConfig } from '../../interfaces';
...
interface ExpenseClaimTableRowProps {
  ...
  handleEdit: (request: IExpenseClaim) => void;
  handleDelete: (id: string) => void;
  handleAction: (request: IExpenseClaim) => void;
