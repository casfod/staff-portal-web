// TravelRequestTableRow.tsx - Refactored to match AdvanceRequestTableRow
import { ITravelRequest, TableHeaderConfig } from '../../interfaces';
...
interface TravelRequestTableRowProps {
  request: ITravelRequest;
  handleEdit: (request: ITravelRequest) => void;
  handleDelete: (id: string) => void;
  handleAction: (request: ITravelRequest) => void;
