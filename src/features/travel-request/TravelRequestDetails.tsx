// TravelRequestDetails.tsx - Refactored to match AdvanceRequestDetails
import { IItemGroup, ITravelRequest } from '../../interfaces';
...
export const TravelRequestDetails = ({ request }: RequestDetailsProps) => {
  ...
  return (
    <DetailContainer>
      ...
      {request?.trNumber && (
        <h1 className="text-center sm:text-lg font-extrabold pb-3 md:p-6">{request?.trNumber}</h1>
      )}
      ...
      <RequestItemsTable items={request.expenses as IItemGroup[]} type="travel" />
