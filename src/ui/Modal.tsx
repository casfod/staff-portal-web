...
function Window({ children, name }: WindowProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm py-4">
      <div
        className="relative bg-white rounded-lg shadow-lgp-6 transition duration-500 overflow-y-scroll"
